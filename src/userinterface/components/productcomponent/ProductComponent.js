...
import { useStyles } from "./ProductComponentCss";
...
export default function ProductComponent(props){
    ...
    var settings = {
      ...
      var images=[
        ...
        {id:1,images:'thumbsup.jpg',name:'Thumsup-Cold Drink ',price:'50',offer:'45',weight:'750 ml'},
        {id:2,images:'monster.png',name:'Monster Energy drink',price:'150',offer:'120',weight:'200 ml'},
        {id:3,images:'starbucks.png', name:'Starbucks cold coffee' ,price:'500',offer:'450',weight:'300 ml'},
        {id:4,images:'cocacola.png',name:'Cocacola-Cold Drink' ,price:'80',offer:'0',weight:'1 L'},
        {id:5,images:'redbull.png',name:'Redbull Energy drink' ,price:'130',offer:'129',weight:'350 ml'},
        {id:6,images:'watermelon.jpg',name:'Watermelon Juice' ,price:'60',offer:'55',weight:'250 ml'},
        {id:7,images:'fanta.png',name:'fanta-Cold Drink' ,price:'160',offer:'0',weight:'450 ml'},
        {id:8,images:'startbuckscoffee.png',name:'starbuckscoffee Latte' ,price:'360',offer:'0',weight:'200 ml'},
